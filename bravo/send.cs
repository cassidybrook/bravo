    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    case 1:
                        Console.WriteLine("select option 1 to Add data into file");
                        AddName();
                        break;
                    case 2:
                        Console.WriteLine("select option 2 to insert information in the file");
                        InsertName();
                        break;
                    case 3:
                        Console.WriteLine("select option 3 to update information in the file");
                        break;
                    case 4:
                        Console.WriteLine("select option 4 to delete data from file");
                        break;
                    case 5:
                        Console.WriteLine("select option 5 to search data from file");
                        break;
                    case 6:
                        Console.WriteLine("select option 6 to display Information from file");
                        break;
                    case 0:
